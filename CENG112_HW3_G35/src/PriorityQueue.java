...
public class PriorityQueue<T> implements PriorityQueueInterface<T>{
	...
	public PriorityQueue()	//constructor with no parameter
	{
	...
	public PriorityQueue(int initialCapacity)	//constructor with initial capacity parameter
	{
	...
	@Override
	public void add(T newEntry) {	//adds element into queue
	...
	@Override
	public T remove() {	//remove element from queue
