...
public class Stack<T> implements StackInterface<T> {	//implements stack's methods
    ...
    public Stack(){	//constructor with no parameter	
        this(DEFAULT_CAPACITY);	//capacity
        initialized = true;	//checks the stack is initialized or not
        this.topIndex = -1;	//
    }

   public Stack(int initialCapacity){	//constructor with capacity parameter
